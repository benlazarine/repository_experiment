...
sudo chmod +x $2.desktop  
echo "Done download: $2.desktop "
################################################################################################################
################################################################################################################
echo "Start download: GUI$2.sh "
wget -O GUI$2.sh $1/GUI$2.sh
sudo mv GUI$2.sh /usr/sbin/
sudo chmod +x /usr/sbin/GUI$2.sh  
echo "Done download: GUI$2.sh "
################################################################################################################
################################################################################################################
echo "Start download: phytoG.png "
wget -O phytoG.png $1/phytoG.png
sudo mv phytoG.png /usr/sbin/
sudo chmod +x /usr/sbin/phytoG.png  
